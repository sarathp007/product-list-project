...
List<GetBannerResponse> getBannerResponseFromJson(String str) => List<GetBannerResponse>.from(json.decode(str).map((x) => GetBannerResponse.fromJson(x)));

String getBannerResponseToJson(List<GetBannerResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
